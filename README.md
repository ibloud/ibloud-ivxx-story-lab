...
Every item must be marked as one of the following:

1. **Documented** — supported by a primary artifact or reliable source.
2. **Attributed** — a public statement accurately attributed to its speaker.
3. **Interpretive** — analysis, association, or meaning produced by Loptr Lab.
4. **Fictionalized** — deliberate character or world-building material.

These labels prevent a fictional or research narrative from implying access to the private intentions of living people.
